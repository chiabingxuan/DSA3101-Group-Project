...
if __name__ == "__main__":
    np.random.seed(42)
    trip_data = pd.read_csv(os.path.join(os.path.dirname(__file__), "../data/sampled_test_trip_data.csv"), keep_default_na=False)
    ...
    combined_trip_data.to_csv(os.path.join(os.path.dirname(__file__), "../data/test_trip_data.csv"), index=False)